  ...
  more_info: |
    <div class="profile-footer">
      ...
      <div class="profile-icons">
        <a href="mailto:deeksha@iitj.ac.in" style="color:black;"><i class="fas fa-envelope"></i></a>
        <a href="/assets/pdf/example_pdf.pdf" style="color:black;"><i class="fas fa-file-pdf"></i></a>
        <a href="https://github.com/deekshaVarshney" style="color:black;"><i class="fab fa-github"></i></a>
        <a href="https://www.linkedin.com/in/deeksha-varshney-5922b57b" style="color:black;"><i class="fab fa-linkedin"></i></a>
        <a href="https://scholar.google.com/citations?user=a6T1uIUAAAAJ" style="color:black;"><i class="fas fa-graduation-cap"></i></a>
