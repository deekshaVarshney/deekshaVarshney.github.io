...
<div id="mtech" class="section-content">
  ...
  <div class="person-row"><div class="person-header"><div class="person-name">Avni Singh</div><button class="toggle-btn" onclick="toggleDesc(this)">Research Area ▾</button></div><div class="person-desc"> Researching AI-driven clinical decision systems for Pulmonary Embolism detection using LLMs and knowledge graphs. </div></div>
